...
async def show_admin_menu(bot, chat_id):
    # 🛠️ تم هنا إصلاح وتوحيد جميع مسارات الـ Callback Data وإضافة زر الصلاحيات الجديد
    keyboard = [
        [
...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. زر التصدير (إصلاح وتفعيل بالكامل)
    ...
    # 2. زر الاستيراد (إصلاح وتفعيل بالكامل)
    ...
    # 3. زر تنظيم وإدارة المذكرات والشكاوى (إصلاح شامل)
    ...
    # 4. زر مراجعة طلبات الإجازات المعلقة (إصلاح شامل)
    ...
    # معالجات الأزرار الفرعية (القرارات)

...
from handlers import start, handle_message, handle_location, handle_document, handle_buttons, TOKEN, OWNER_PHONE, OWNER_CHAT_ID
...
def main():
    # تهيئة جداول قاعدة البيانات والبيانات التأسيسية للمالك
    init_db()
    seed_initial_owner()
    
    # خادم الويب لمنع الـ Timeout على منصة Render
    web_thread = threading.Thread(target=run_web_server, daemon=True)
    web_thread.start()
    
    # بناء مشغل البوت بالأحداث الموزعة
